...
cms.init.add(['page_add', 'page_edit'], function()
{
	...
	$('#pageEditPartAddButton').click(function()
	{
		...
		'<i class="zmdi zmdi-plus-circle-o-duplicate zmdi-fontz zmdi-hc-fw style-okno-vsplyv"   ></i><p> <span><input class="input-text ui-text-inline-style" placeholder="'+__('Page part name')+'" type="text" name="part_name" /></span></p>'+
		'</form>');

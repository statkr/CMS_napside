	...
	$('#IRSettingsCacheAddButton').click(function(){
		...
		buttons[__('Add')] = function()
		{
			...
			{			
				...
				$('#IRSettingsCache').prepend('<label class="checkbox-inline"><input id="IRSettingsCacheCkeckbox-'+size+'" type="checkbox" value="'+size+'" name="setting[cache_sizes][]" checked /> <?php echo $size; ?> <i class="input-helper"></i><p>'+size+'</p></label>');

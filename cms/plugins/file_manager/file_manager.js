...
cms.plugins.uploader = function(options)
{
	...
	var layoutHTML = '<form class="fm-fileuploader-form" action="upload.php" method="POST" enctype="multipart/form-data"><i class="zmdi zmdi-image-alt zmdi-pu zmdi-hc-fw style-okno-vsplyv" style="font-size: 140px;"></i>'
	...
	dialogOptions.buttons[__('Close23323')] = function()
	{
...
{	
	...
	{
		var html = '<form class="dialog-form" onsubmit="return false;">'
		          +'<p><input class="input-text ui-text-inline-style" placeholder="'+__('Folder name')+'" type="text" type="text" name="name" value=""></p>'
				  +'<i class="zmdi zmdi-folder-outline zmdi-fontd zmdi-hc-fw style-okno-vsplyv" style="font-size: 340px;"></i></form>';

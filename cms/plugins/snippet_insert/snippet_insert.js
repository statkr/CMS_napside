...
{	
	$('#pageEdit .item-title').append('<a class="item-snippet_insert-button" href="#" title="'+__('Insert snippet')+'"><i  class="zmdi zmdi-insertsnippet zmdi-receipt"></i></a>');
		...
		$.ajax({
			...
			success: function(data)
			{
				...
				var html = '<div class="snippet_insert-dialog map">'
						  ...
						  +'<ul class="map-items" style="padding: 0px 11px;"></ul>'
						  +'</div>';
				...
				{
					$map_items.append('<li class="item items-2"><a href="javascript:;">'+data[i].name+'</a></li>');
				}

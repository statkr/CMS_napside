...
function cache_view_page_edit_options_handler($page)
{
	if ( AuthUser::hasPermission(array('administrator','developer')) )
	{
		...
		echo '  <div class="toggle-switch switch-edit-block"><input id="CachePageCheckbox2" type="checkbox" name="cache[cache_page]" value="yes" class="toggle-switch__checkbox" '. ($page_caching === true ? 'checked': '') .'><i class="toggle-switch__helper"></i></div>';
}

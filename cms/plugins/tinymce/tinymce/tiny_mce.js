...
(function(m) {
    ...
    m.html.Schema = function(q) {
        ...
        function s(G) {
            var F, B, U, Q, V, A, D, P, S, L, T, X, J, E, R, z, N, C, W, Y, K, O, I = /^([#+-])?([^\[\/]+)(?:\/([^\[]+))?(?:\[([^\]]+)\])?$/,
                M = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
                H = /[*?+]/;
            if (G) {
                G = i(G);
...
(function(b) {
    ...
    b.html.DomParser = function(g, h) {
        ...
        f.parse = function(v, m) {
            var n, H, A, z, C, B, x, r, E, K, y, o, D, J = [],
                t, k, s, p, u, q;
            m = m || {};
            i = {};
            c = {};
...
(function(c) {
    ...
    c.create("tinymce.ui.SplitButton:tinymce.ui.MenuButton", {
        ...
        renderHTML: function() {
            ...
            }, '<span style="display:none;" class="mceIconOnly" aria-hidden="true">qqq</span>');
            i += "<td >" + b.createHTML("a", {
                role: "button",
                id: f.id + "_open",
                tabindex: "-1",
    ...
    m.create("tinymce.Editor", {
        ...
        setupIframe: function(x) {
            ...
            q.parser.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function(t, A) {
                var B = t.length,
                    C, s = q.schema.getNonEmptyElements();
                while (B--) {
                    C = t[B];
                    if (C.isEmpty(s)) {
    ...
    l.create("tinymce.ForceBlocks", {
        ...
        setup: function() {
            ...
            if (l.isWebKit) {
                function r(t) {
                    var s = o.getRng(),
                        x, A = u.create("div", null, " "),
                        z, y = u.getViewPort(t.getWin()).h;
        ...
        insertPara: function(Q) {
            var E = this,
                ...
                G = F.getRangeAt(0),
                U = R.body;
            var J, K, H, O, N, q, o, u, z, m, C, T, p, x, I, L = M.getViewPort(v.getWin()),
                B, D, A;
    ...
    b.create("tinymce.ui.Button:tinymce.ui.Control", {
        ...
        renderHTML: function() {
            ...
            if (e.image && !(this.editor && this.editor.forcedHighContrastMode)) {
                ...
                d += '<span class="mceIcon ' + e["class"] + '"><i class="zmdi zmdistyle zmdi' + e["class"] + '"></i></span>' + (c ? '<span class="' + f + 'Label">' + c + "</span>" : "")
            }
            d += '<span class="mceVoiceLabel mceIconOnly" style="display: none;" id="' + this.id + '_voice">' + e.title + "</span>";
            d += "</a>";
            return d
    ...
    d.create("tinymce.ui.ListBox:tinymce.ui.Control", {
        ...
        renderHTML: function() {
            ...
            i += "<td>" + c.createHTML("a", {
                ...
                onclick: "return false;",
                onmousedown: "return false;"
            }, '<span><span   class="mceIconOnly" aria-hidden="true"><i class="zmdi zmdistyles zmdibottom"></i></span></span>') + "</td>";
            i += "</tr></tbody></table></span>";
            return i
        },
        showMenu: function() {
    ...
    c.create("tinymce.ui.SplitButton:tinymce.ui.MenuButton", {
        ...
        renderHTML: function() {
            ...
            if (g.image) {
                ...
                e = b.createHTML("span", {
                    "class": "mceAction " + g["class"]
                }, "<i class='zmdi zmdistyle zmdi"+g["class"]+"olo'></i>")
            }
            e += b.createHTML("span", {
                "class": "mceVoiceLabel mceIconOnly",
                id: f.id + "_voice",
            ...
            e = b.createHTML("span", {
                "class": "mceOpen " + g["class"]
            }, '<span  class="mceIconOnly" aria-hidden="true"><i class="zmdi zmdistyles zmdibottom"></i></span>');
            i += "<td >" + b.createHTML("a", {
                role: "button",
                id: f.id + "_open",
                tabindex: "-1",

...
<form id="snippetEditForm" action="<?php echo $action=='edit' ? get_url('snippet/edit/'. $snippet->name): get_url('snippet/add/' . $snippet->name); ?>" method="post">
	...
	<div id="snippetEdit" class="card">
		...
		<p id="snippetEditContent">
			<textarea style="    resize: vertical; width:100%; height: 450px; min-height: 100px;" id="snippetEditContentField" name="snippet[content]" tabindex="7" spellcheck="false" wrap="off"><?php echo htmlentities($snippet->content, ENT_COMPAT, 'UTF-8'); ?></textarea>
		</p>
		...
		<div class="box-buttons">
			...
			<button class="button-submit-style2" style="margin-left:7px;"type="submit" name="continue"><i class="zmdi zmdi-check-all"></i> <?php echo __('Save and Continue editing'); ?></button>
                         ...
                         <a class="button-submit-style-a" href="<?php echo get_url('snippet'); ?>"><i class="zmdi zmdi-undo"></i> <?php echo __('Cancel'); ?></a>
